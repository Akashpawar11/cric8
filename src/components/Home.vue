                ...
                <div class="col-sm-6 col-md-4 col-lg-3 col-xl-3 matchCard" v-for="match in data" :key="match.id">
                    <div class="matchData mx-auto">
                        ...
                        <div class="matchScore">
                            ...
                            <h4><b>{{match.matchInfo.team1.teamSName}}</b> {{match.matchScore.team1Score.inngs1.runs}} - {{match.matchScore.team1Score.inngs1.wickets}}</h4>
                            <h4><b>{{match.matchInfo.team2.teamSName}}</b> {{match.matchScore.team2Score.inngs1.runs}} - {{match.matchScore.team2Score.inngs1.wickets}}</h4>
                        </div>
